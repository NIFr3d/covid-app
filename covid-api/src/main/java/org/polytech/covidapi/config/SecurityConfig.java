...
public class SecurityConfig {
    ...
    protected SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        .requestMatchers("/api/user/admin/**").hasAnyAuthority(ERole.ADMIN.toString(), ERole.SUPERADMIN.toString())
        ...
        .requestMatchers("/api/center/medecin/**").hasAnyAuthority(ERole.ADMIN.toString(), ERole.MEDECIN.toString())
        .requestMatchers("/api/center/**").hasAuthority(ERole.SUPERADMIN.toString())	
